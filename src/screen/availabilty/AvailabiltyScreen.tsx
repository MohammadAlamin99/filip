  ...
  const workers: Worker[] = [
    {
      ...
      isAvailable: true,
      bio:
        'Experienced Fine Dining Server With 5+ Years In High-Volume Environments. Quick Learner And...',
    ...
    },
    {
      ...
      isAvailable: true,
      bio:
        'Hard Working And Reliable. Available For Late Shifts And Weekends. Fast In The Kitchen And Organized...',
